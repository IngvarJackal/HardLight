...
xenoborgs-welcome = You're a xenoborg. Protect and help the mothership core to make more xenoborgs. and eventually turn all carbon-based life form into silicon. Note: Colonial Command runs a passive sector threat detection grid; you have at least 90 minutes before it may flag the possibility of a xenoborg mothership in the sector, so don't count on staying hidden forever.

mothership-welcome = You're the mothership core. Guide the xenoborgs so they can bring your materials and sentient brains so you can grow the xenoborg army and turn all carbon-based life form into silicon. Note: Colonial Command runs a passive sector threat detection grid; you have at least 90 minutes before it may flag the possibility of a xenoborg mothership in the sector, so don't count on staying hidden forever.
